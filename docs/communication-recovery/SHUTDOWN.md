...
session/registry fence are load-bearing. Independent subagent review is pending the service
usage limit; the user requested separate implementation pushes for review afterward.
