...
| 10+ | roles hardening (owner-signed grants verified at read + committer join-time re-check + full-device-id role keys + sticky owner) · on-demand admin invites · member removal in the UI | planned |
