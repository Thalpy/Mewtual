...
| 8… | rendezvous auto-discovery in the UI · wiki · **disk persistence then per-file encryption-at-rest** (paired — see Known limitations) · chunked large-file transfer · last-copy-safe blob retention | planned |
