...
| P1 durable storage | Implemented/tested: recovery/owner receipt saves, peak-space accounting, combined bounded recovery + owner-journal inventory and unpublished-staging cleanup | Remaining managed-file types, sole coordinator, multi-record settlement/restart transaction |
