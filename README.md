...
| 9 | **disk persistence + encryption-at-rest** — [designed](docs/design-persistence.md), 8 slices. 9a key vault + 9b sealing blob store (encrypted at rest) done; next the sealed MLS storage provider | in progress |
