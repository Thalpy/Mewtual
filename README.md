...
| 8… | rendezvous discovery in the UI · status · wiki · **disk persistence then per-file encryption-at-rest** (paired) · chunked large-file transfer · last-copy-safe blob retention | planned |
