...
| 8… | rendezvous discovery in the UI · **disk persistence then per-file encryption-at-rest** (paired) · chunked large-file transfer · last-copy-safe blob retention | planned |
