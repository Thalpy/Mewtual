...
| 9 | **disk persistence + encryption-at-rest** — [designed](docs/design-persistence.md) (sealed on-disk MLS storage + keystore; survive restart + at-rest encryption), 8 reviewed slices | designed |
